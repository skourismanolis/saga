<template>
  <b-container>
    ...
    <form @submit.prevent="CreateIssue">
      ...
      <b-row class="my-1">
        <b-col sm="3">
          <label for="input-title">Title<br/>({{getTitleLength}}/30)</label>
      ...
      <b-row class="my-1">
        ...
        style="width: 10%;height:40px;">Category
        </label>
        
        <b-select id="category-selector" v-model="issue.category" :options="Categories" class="my-1" required></b-select>
      </b-row>
    </form>
  </b-container>
</template>
