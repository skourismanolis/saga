...
|Ομάδα |Περιγραφή  |
--- | --- 
|Μέλος ομάδας project|Οι χρήστες αυτοί έχουν ως βασική αρμοδιότητα την ολοκλήρωση tasks του project στο οποίο είναι μέλη. Επιπλέον μπορούν να δημιουργήοσυν epics, sprints και tasts οι ίδιοι ανάλογα με τις απαιτήσεις του project.|
