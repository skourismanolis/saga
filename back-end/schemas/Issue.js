...
const schema = Joi.object().keys({
	...
	idEpic: Joi.number().integer().min(c.MIN_ID).required().allow(null),
	idLabel: Joi.number().integer().min(c.MIN_ID).required().allow(null),
	idSprint: Joi.number().integer().min(c.MIN_ID).required().allow(null),
	idColumn: Joi.number().integer().min(c.MIN_ID).required().allow(null),
